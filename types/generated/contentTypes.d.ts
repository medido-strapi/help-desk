...
export interface ApiCustomerServiceContactInformationCustomerServiceContactInformation
...
export interface ApiDistributorDistributor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    distributorId: Schema.Attribute.UID & Schema.Attribute.Required;
...
export interface ApiFaqArticleFaqArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    distributorContents: Schema.Attribute.Component<
      'distributor.faq-article-content',
      true
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiResolvingProblemArticleResolvingProblemArticle
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::resolving-problem-article.resolving-problem-article'
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
